...
public class CommentController {
	...
	private List<CommentVO> mCommentServiceList(@RequestParam int bno) throws Exception { // view∞° 
	...
	private int mCommentServiceUpdateDelete(@RequestParam(value="cno") int cno) throws Exception {
