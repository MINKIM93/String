...
<tr>
	...
	<td width="400">
		...
		required placeholder="최소6~최대10,숫자와 알파벳만 사용">
		</td>
	</tr>
	<tr>
		...
		<td width="400">
			...
			placeholder="최소6~최대10, 숫자와 알바벳만 사용">
		</td>
	</tr>
	<tr>
		<td width="110">성별</td>
	...
	<tr>
		<td>전화번호</td>
		<td><input type="tel" name="tell1" size="3" maxlength="3"> -
...
<tr>
	...
	<td width="400"><textarea name="intro" rows="5" cols="50" style="ime-mode:inactive"></textarea>
</tr>
<tr>
